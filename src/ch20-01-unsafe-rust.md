...
با داده‌های قابل تغییر که به صورت جهانی قابل دسترسی هستند، اطمینان از نبود data race دشوار است، به همین دلیل راست متغیرهای static قابل تغییر را ناامن می‌داند. در صورت امکان، استفاده از تکنیک‌های هم‌زمانی و اشاره‌گرهای هوشمند ایمن در برابر ریسمان که در فصل 16 بررسی کردیم، ترجیح داده می‌شود تا کامپایلر بررسی کند که دسترسی به داده‌ها از ریسمان‌های مختلف ایمن انجام می‌شود.

...
<ul dir="rtl">
  ...
  <li>`const` - تعریف آیتم‌های ثابت یا اشاره‌گر (Pointer) های خام ثابت</li>
  <li>`continue` - ادامه به تکرار بعدی حلقه</li>
  <li>`crate` - در یک مسیر ماژول، به ریشه جعبه (crate) اشاره دارد</li>
  ...
  <li>`fn` - تعریف یک تابع یا نوع اشاره‌گر (Pointer) تابع</li>
  ...
  <li>`mut` - نشان دادن تغییرپذیری در ارجاعات، اشاره‌گر (Pointer) های خام، یا الگوهای بایندینگ</li>
